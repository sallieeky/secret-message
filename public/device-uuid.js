...
!(function (exports) {
        ...
        DeviceUUID = function (options) {
            ...
            return (
                        ...
                        function convertToWordArray(string) {
                            for (
                                var lWordCount,
                                    ...
                                    lNumberOfWordsTemp2 =
                                        (lNumberOfWordsTemp1 -
                                            (lNumberOfWordsTemp1 % 64)) /
                                        64,
                                    lNumberOfWords =
                                        16 * (lNumberOfWordsTemp2 + 1),
                ...
                (this.getOS = function (string) {
                    switch (!0) {
                        ...
                        case this._OS.OSXMountainLion.test(string):
                            return (
                                (this.Agent.isMac = !0), "OS X Mountain Lion"
                            );
                ...
                (this.testCompatibilityMode = function () {
                    ...
                    if (
                        this.Agent.isIE &&
                        /Trident\/(\d)\.0/i.test(ua.Agent.source)
                    ) {
                        var tridentVersion = parseInt(RegExp.$1, 10),
                            version = parseInt(ua.Agent.version, 10);
                        7 === version &&
                            7 === tridentVersion &&
                            ((ua.Agent.isIECompatibilityMode = !0),
                            (ua.Agent.version = 11)),
                            7 === version &&
                                6 === tridentVersion &&
                                ((ua.Agent.isIECompatibilityMode = !0),
                ...
                (this.testKindleFire = function () {
                    ...
                    switch (!0) {
                        case /KFOT/gi.test(ua.Agent.source):
                            return (
                                (this.Agent.isKindleFire = !0), "Kindle Fire"
                            );
                        case /KFTT/gi.test(ua.Agent.source):
                            return (
                                (this.Agent.isKindleFire = !0), "Kindle Fire HD"
                            );
                        case /KFJWI/gi.test(ua.Agent.source):
                            return (
                                (this.Agent.isKindleFire = !0),
                                "Kindle Fire HD 8.9"
                            );
                ...
                (this.parse = function (source) {
                    ...
                    return (
                        (ua.Agent.source = source
                            .replace(/^\s*/, "")
                            .replace(/\s*$/, "")),
                        (ua.Agent.os = ua.getOS(ua.Agent.source)),
                        (ua.Agent.platform = ua.getPlatform(ua.Agent.source)),
                        (ua.Agent.browser = ua.getBrowser(ua.Agent.source)),
                        (ua.Agent.version = ua.getBrowserVersion(
                            ua.Agent.source
                        )),
                        ua.testBot(),
                        ua.testSmartTV(),
    ...
    return (
        (exports.DeviceUUID = DeviceUUID), new DeviceUUID(navigator.userAgent)
    );
})(this);
